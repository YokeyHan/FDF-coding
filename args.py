...
def get_args() -> argparse.Namespace:
    ...
    parser.add_argument("--contrastive_loss_weight", type=float, default=0.1, help="weight for contrastive loss")  # 新增参数

    # cluster (新增两项)
    parser.add_argument("--z_dim", type=int, default=4, help="subspace dimension")
    parser.add_argument("--num_clusters", type=int, default=6, help="number of clusters")
